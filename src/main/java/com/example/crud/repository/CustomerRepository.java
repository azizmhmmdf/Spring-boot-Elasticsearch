...
public class CustomerRepository {
    ...
    public Object getCustomers(FilterQuery filter) throws Exception{
        ...
        if(queryResult != null){
            return processMappingGetCustomers(queryResult);
        }
        return null;
    }
    ...
    public Object processMappingGetCustomers(JsonNode queryResult) throws Exception{
    ...
    public Object create(Customer paramsCustomer) throws Exception{
        ...
        if(checkCustomer != null){
            return processCreate(checkCustomer, paramsCustomer, hasheId);
        }
        return null;
    }

    public Object processCreate(JsonNode checkCustomer, Customer paramsCustomer, String hasheId) throws Exception {
    ...
    public Object update(Customer paramsCustomer) throws Exception{
        ...
        if(checkCustomer != null){
            return processUpdate(checkCustomer, paramsCustomer);
        }
        return null;
    }

    public Object processUpdate(JsonNode checkCustomer, Customer paramsCustomer) throws Exception {
        if( checkCustomer.get("found").asBoolean()){
